...
protected:
    static constexpr uint8 AES_KEY_LEN      = 32;  // AES 秘钥长度
    static constexpr uint8 AES_KEY_EXP_SIZE = 240; // AES 秘钥扩展长度
    static constexpr uint8 AES_BLOCK_SIZE   = 16;  // AES 块长度
    static constexpr uint8 NR               = 14;  // 循环轮数
    static constexpr uint8 NK               = 8;   // 秘钥列数
    static constexpr uint8 NB               = 4;   // aes组成一个状态的列数，对于aes是常量
    struct AesContext
    {
...
{
protected:
    static constexpr uint8 AES_KEY_LEN      = 16;  // AES 秘钥长度
    static constexpr uint8 AES_KEY_EXP_SIZE = 176; // AES 秘钥扩展长度
    static constexpr uint8 AES_BLOCK_SIZE   = 16;  // AES 块长度
    static constexpr uint8 NR               = 10;  // 循环轮数
    static constexpr uint8 NK               = 4;   // 秘钥列数
    static constexpr uint8 NB               = 4;   // aes组成一个状态的列数，对于aes是常量
};
