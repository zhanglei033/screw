...
static uint32_t* xxtea_to_uint_array(const uint8_t* data, size_t len, int inc_len, size_t* out_len) DECL_NOEXCEPT
{
    uint32_t* out;
...
static uint8_t* xxtea_to_ubyte_array(const uint32_t* data, size_t len, int inc_len, size_t* out_len) DECL_NOEXCEPT
{
    uint8_t* out;
#if !(defined(BYTE_ORDER) && (BYTE_ORDER == LITTLE_ENDIAN))
    size_t i;
...
static uint32_t* xxtea_uint_encrypt(uint32_t* data, size_t len, uint32_t* key) DECL_NOEXCEPT
{
...
static uint32_t* xxtea_uint_decrypt(uint32_t* data, size_t len, uint32_t* key) DECL_NOEXCEPT
{
    uint32_t n = (uint32_t)len - 1;
...
static uint8_t* xxtea_ubyte_encrypt(const uint8_t* data, size_t len, const uint8_t* key, size_t* out_len) DECL_NOEXCEPT
{
    uint8_t* out;
...
static uint8_t* xxtea_ubyte_decrypt(const uint8_t* data, size_t len, const uint8_t* key, size_t* out_len) DECL_NOEXCEPT
{
    uint8_t* out;
    uint32_t *data_array, *key_array;
    size_t data_len, key_len;
